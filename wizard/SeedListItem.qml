...
ColumnLayout {
    ...
    RowLayout {
        ...
        MidasComponents.Label {
            color: lineEdit.inputHasFocus ? MidasComponents.Style.defaultFontColor : MidasComponents.Style.dimmedFontColor
            fontSize: 13
            text: (wordNumber + 1)
        ...
        MidasComponents.TextPlain {
            ...
            color: wordsMatch ? (MidasComponents.Style.blackTheme ? "#00FF00" : "#008000") : "#FF0000"
            themeTransition: false
            onTextChanged: {
    ...
    Rectangle {
        id: underLine
        color: lineEdit.inputHasFocus ? MidasComponents.Style.defaultFontColor : MidasComponents.Style.appWindowBorderColor
