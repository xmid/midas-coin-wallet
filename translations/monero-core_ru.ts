...
<context>
    ...
    <message>
        ...
        <translation>Это облегчит отправку и получение Midas и снизит количество ошибок при ручном вводе адресов.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ВНИМАНИЕ! Не используйте ваши ключи Midas на другом форке, особенно, ЕСЛИ форк не имеет средств защиты от повторного использования ключей. Это может нанести ущерб вашей конфиденциальности.</translation>
    </message>
    <message>
        ...
        <translation>ВНИМАНИЕ: Копирование вашей мнемонической фразы в буфер обмена может сопровождаться перехватом этих данных различным вредоносным программным обеспечением, которое отправит вашу мнемонику злоумышленнику, после чего ваши Midas могут быть украдены. Пожалуйста, вводите вашу мнемоническую фразу вручную с клавиатуры.</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some Midas. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Майнинг на вашем компьютере помогает укрепить сеть Midas. Чем больше людей занимаются майнингом, тем сложнее атаковать сеть.

Также майнинг дает вам потенциальный шанс заработать немного Midas. Ваш компьютер будет создавать хэши в попытках найти блок. Если вы найдете блок в процессе майнинга, вы получите соответствующую награду. Удачи!</translation>
    </message>
    <message>
        <location filename="../pages/Mining.qml" line="76"/>
...
<context>
    ...
    <message>
        ...
        <translation>Встроенная версия Midas: </translation>
    </message>
    <message>
...
Старый файл, содержащий кеш кошелька будет переименован и сможет быть восстановлен позднее.
    ...
    <message>
        ...
        <translation>Пожертвовать Midas</translation>
    </message>
    <message>
        <location filename="../pages/settings/SettingsInfo.qml" line="412"/>
        <source>Donation to Midas Core Team</source>
        <translation>Пожертвование Основной команде Midas</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Использовать сторонний узел для подключения к сети Midas. Менее безопасно, но более быстро и удобно.</translation>
    </message>
    <message>
        ...
        <translation>Чтобы получить список удаленных узлов, введите &apos;Midas remote node&apos; в вашем любимом поисковике. Пожалуйста, убедитесь, что выбранному узлу можно доверять.</translation>
    </message>
    <message>
...
Вы можете изменить пароль в настройках кошелька.</translation>
    ...
    <message>
        ...
        <translation>Получайте Midas для вашего бизнеса, легко.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На этой странице можно взаимодействовать с общей базой данных RingDB. Эта база данных предназначается для использования кошельками Midas или их клонов, которые смогут повторно использовать ключи Midas.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того чтобы скрыть какие входы в транзакциях Midas потрачены, третья сторона не должна сообщать какие входы в кольце уже задействованы в трате. Ведь если это сделать, то это ослабит защиту, обеспечиваемую кольцевыми подписями. Если известно, что все, кроме одного из входов, уже потрачены, то фактически трата входа становится очевидной, тем самым аннулируется эффект кольцевых подписей, одного из трех основных уровней защиты конфиденциальности Midas.&lt;br&gt;Чтобы помочь транзакциям избежать траты этих входов, можно использовать список известных израсходованных выходов, чтобы избежать их использования в новых транзакциях. Такой список поддерживается проектом Midas и доступен на веб-сайте getMidas.org, и вы можете импортировать этот список здесь.&lt;br&gt;Кроме того, вы можете просканировать блокчейн Midas (и его клонов) самостоятельно, используя инструмент Midas-blockchain-mark-spent-outputs, чтобы создать список известных потраченых выходов.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Чтобы избежать аннулирования защиты, предоставляемой кольцевыми подписями Midas, выход не должен быть потраченным с другими значениями размера кольца и на других блокчейнах. Хотя, как правило, это не является проблемой, в некоторых случаях повторное использование ключей Midas позволяет потратить существующие выходы. В таких случаях вам необходимо позаботиться, чтобы эти существующие выходы использовали одно и то же кольцо в обеих блокчейнах.&lt;br&gt;Это может быть сделано автоматически с помощью любого программного обеспечения для повторного использования ключей от Midas-клонов, и даже если эти клоны не предоставляют подобную защиту, вы все еще можете проверить, что ваши транзакции защищены, путем ручного введения размера кольца на этой странице, которая позволит вам потратить ваши Midas безопасно.&lt;br&gt;Если вы не используете программное обеспечения от Midas-клонов, вам ничего не нужно делать, так как все будет сделано автоматически.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Здесь записываются кольца, используемые выходами, проводимыми на Midas, в цепочке повторного использования ключей, так что одно и то же кольцо можно использовать повторно, чтобы избежать проблем с конфиденциальностью.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Midas (например: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
Подтверждающее сообщение:
    ...
    <message>
        ...
        <translation>Midas успешно отправлены</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Midas</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Доступна новая версия Midas v%1.</translation>
    </message>
    <message>
        <location filename="../components/UpdateDialog.qml" line="98"/>
        <source>Please visit getMidas.org for details</source>
        <translation>Пожалуйста, посетите getMidas.org для получения дополнительной информации</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Чтобы обмениваться данными с сетью Midas, ваш кошелек должен быть подключен к узлу Midas. Для лучшей конфиденциальности рекомендуется запустить свой собственный узел.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Кроме того, вы можете указать узел начальной загрузки, чтобы немедленно начать использование Midas.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Выберете эту опцию, если вы впервые пользуетесь Midas.</translation>
    </message>
    <message>
        <location filename="../wizard/WizardHome.qml" line="104"/>
    ...
    <message>
        ...
        <translation>Создать новый кошелек, подключившись к вашему аппаратному кошельку Midas.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Этот режим идеально подходит для работы с небольшими суммами Midas. У вас есть доступ ко всем основным функциям для совершения транзакций и управления ими. Программа автоматически подключится к сети Midas, чтобы вы немедленно могли начать использование Midas.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Создавайте портативный кошелек и используйте его на любом ПК. Включите данный функционал, если вы установили Midas на USB-накопитель, внешний диск или любой другой портативный носитель.</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Чтобы обмениваться данными с сетью Midas, ваш кошелек должен быть подключен к узлу Midas. Для лучшей конфиденциальности рекомендуется запустить свой собственный узел.
...
<context>
    ...
    <message>
        ...
        <translation>Вы бы хотели, чтобы записи Midas GUI производились на рабочий стол?</translation>
    </message>
    <message>
