...
TextArea {
    ...
    states: [
        State {
            name: "black";
            when: textArea.themeTransition && MidasComponents.Style.blackTheme
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorBlackTheme ? textArea.colorBlackTheme : MidasComponents.Style._b_defaultFontColor
                }
            }
        }, State {
            name: "white";
            ...
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorWhiteTheme ? textArea.colorWhiteTheme : MidasComponents.Style._w_defaultFontColor
                }
            }
        }
    ]
