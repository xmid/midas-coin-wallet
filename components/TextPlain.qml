...
Text {
    ...
    Rectangle {
        ...
        color: root.focus ? MidasComponents.Style.titleBarButtonHoverColor : "transparent"
    }
    ...
    MidasEffects.ColorTransition {
        ...
        targetObj: root
        duration: 750
        blackColor: root.themeTransitionBlackColor !== "" ? root.themeTransitionBlackColor : MidasComponents.Style._b_defaultFontColor
        whiteColor: root.themeTransitionWhiteColor !== "" ? root.themeTransitionWhiteColor : MidasComponents.Style._w_defaultFontColor
    }
