...
MenuItem {
    ...
    background: Rectangle {
        color: MidasComponents.Style.buttonBackgroundColorDisabledHover
        opacity: 0
    ...
    contentItem: RowLayout {
        ...
        Text {
            ...
            color: MidasComponents.Style.buttonTextColor
        ...
        Text {
            color: MidasComponents.Style.blackTheme ? MidasComponents.Style.buttonTextColor : MidasComponents.Style.defaultFontColor
