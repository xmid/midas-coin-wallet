...
MouseArea {
    ...
    Menu {
        ...
        background: Rectangle {
            border.color: MidasComponents.Style.buttonBackgroundColorDisabledHover
            border.width: 1
            radius: 2
            color: MidasComponents.Style.blackTheme ? MidasComponents.Style.buttonBackgroundColorDisabled : "#E5E5E5"
        }
        ...
        MidasComponents.ContextMenuItem {
